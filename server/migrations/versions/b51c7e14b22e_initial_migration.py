...
Revision ID: b51c7e14b22e
Revises: 
Create Date: 2023-12-16 14:31:57.789441
...
def upgrade():
    ...
    sa.UniqueConstraint('likeable_id'),
    sa.UniqueConstraint('likeable_type'),
    sa.UniqueConstraint('liker_type')
    )
