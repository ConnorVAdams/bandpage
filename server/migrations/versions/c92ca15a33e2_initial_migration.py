...
Revision ID: c92ca15a33e2
Revises: 
Create Date: 2023-12-09 16:41:37.219027
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('likeable_type', 'likeable_id', 'liker_type', 'artist_id', 'fan_id', name='unique_likes')
    )
